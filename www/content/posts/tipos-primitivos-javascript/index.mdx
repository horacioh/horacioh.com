...
draft: false
lang: es
excerpt: "En JavaScript tenemos por ahora siete (7) tipos de valores primitivos que es importante aprender y saber cómo utilizarlos para evitar errores inesperados en nuestros programas y más importante, sacarle provecho a sus utilidades."
slug: "/writing/tipos-primitivos-javascript"
featured: true
tags:
  - español
  - javascript
