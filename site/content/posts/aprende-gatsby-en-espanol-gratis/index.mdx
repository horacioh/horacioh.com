...
<p style={{ padding: 16, borderRadius: 4, marginTop: 12, marginBottom: 12, backgroundColor: "rgba(255,229,100,0.2)", fontSize: 24, lineHeight: 1.2, fontWeight: 'bold'}}>Apuntate aqui! <span role="img" aria-label="hand emoji pointing to the right">👉</span> <a href="https://hhg.link/curso-gatsby" target="_blank">aprendegatsby.com</a></p>
...
<iframe
  width="100%"
  height="400"
  src="https://www.youtube.com/embed/eaTcBsSuS3k"
  frameBorder={0}
